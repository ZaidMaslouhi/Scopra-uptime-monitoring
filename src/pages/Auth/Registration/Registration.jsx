      ...
      <section>
        <form>
          ...
          <div className="flex mb-3 mx-2">
            <input type="checkbox" name="rememberMe" id="rememberMe" className="accent-slate-700 outline-none" />
        ...
        >
          <FcGoogle className="inline text-xl mr-1" /> Or sign up with Google
        </button>
        <div className="mt-6">
          <p className="text-xs text-center text-slate-500">Already have an account? <Link to="/login" className="font-bold text-slate-900">Sign in now</Link></p>
        </div>
      </section>
    </InitLayout>
  );
